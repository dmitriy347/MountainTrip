...
urlpatterns = [
    ...
    path(
        "resort/<slug:resort_slug>/",
        views.ResortDetailView.as_view(),
        name="resort_detail",
    ),
    ...
    path(
        "trips/<int:trip_id>/media/add/",
        views.TripMediaAddView.as_view(),
        name="trip_media_add",
    ),
    path(
        "media/<int:media_id>/delete/",
        views.TripMediaDeleteView.as_view(),
        name="trip_media_delete",
    ),
]
